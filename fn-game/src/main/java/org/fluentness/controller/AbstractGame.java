...
public abstract class AbstractGame implements View {
    ...
    public AbstractGame(Background background, Camera camera, Light light, Fog fog, Terrain[] terrains, Entity[]... entities) {
