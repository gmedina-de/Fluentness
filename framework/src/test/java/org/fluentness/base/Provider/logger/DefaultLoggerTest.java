package org.fluentness.base.Provider.logger;
...
//    @Before
//    public void setUp() {
//        new Base().add(new DefaultConfig(new DefaultEnvironment()));
//
...
//        Fluentness.getBase().setLogger(new DefaultLogger(internalLogger));
//    }
//
//    @Test
