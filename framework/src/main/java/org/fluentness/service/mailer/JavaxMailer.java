...
public class JavaxMailer implements Mailer {
    ...
    public MessageBuilder mail(String... to) throws MessagingException {
        ...
        prop.put("mail.smtp.port", String.valueOf(configurator.getOrDefault(Configurator.mailing_port, 25)));
    ...
    public void send(MessageBuilder messageBuilder) throws MessagingException {
        try {
            ...
            t.connect(
                configurator.getOrDefault(Configurator.mailing_server, "localhost"),
                configurator.getOrDefault(Configurator.mailing_username, ""),
                configurator.getOrDefault(Configurator.mailing_password, "")
            );
