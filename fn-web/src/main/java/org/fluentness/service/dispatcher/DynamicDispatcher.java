...
public class DynamicDispatcher extends HttpServlet implements Dispatcher {
    ...
    public DynamicDispatcher(Authentication authentication, Log log, Configuration configuration) {
