...
public abstract class AbstractStringTranslator implements Translator {

    static final String SEPARATOR = "#L#";

    private final Map<String, Translations> messages = new HashMap<>();
        ...
        try {
            ...
            for (Field field : declaredFields) {
                if (field.getType().equals(String.class)) {
                    ...
                    messages.put(string, new Translations(string));
                }
            }
    ...
    public String translate(String translation, String... sortedLanguages) {
        return messages.getOrDefault(translation, new Translations(translation)).translate(sortedLanguages);
    }
